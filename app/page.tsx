...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-5 pt-3 text-emerald-400 text-2xl font-bold">
      <div className="flex items-center justify-center gap-4 md:gap-14">
        
          <button onClick={() => setTerminalMode("terminal")} className="bg-slate-800/80 px-5 py-3 rounded-xl">About</button>
          <button onClick={() => setTerminalMode("stream")} className="bg-slate-800/80 px-5 py-3 rounded-xl">Stream</button>
